                        ...
                        case opts.groupmarker.end:
                            if (openingToken = openenings.pop(), void 0 !== openingToken) {
                                if (openenings.length > 0) {
                                    ...
                                    currentToken.matches.push(openingToken); } } else {
                                defaultCase();
                                    }
                                break;
    ...
    function maskScope(actionObj, maskset, opts)
    {
        ...
        function stripValidPositions(start, end, nocheck, strict)
        {
            ...
            for (resetMaskSet(!0), i = startPos + 1; i <= getLastValidPosition(); ) {
                ...
                if (startPos > i && (i = startPos + 1), void 0 === getMaskSet().validPositions[i] && isMask(i) || void 0 !== s) {
                    i++; } else {
        ...
        function getTests(pos, ndxIntlzr, tstPs)
        {
                        ...
                        if (match.isGroup && quantifierRecurse !== match) {
                            ...
                            if (-1 === altIndex || "string" == typeof altIndex) {
                                ...
                                if ("string" == typeof altIndex) {
                                    altIndexArr = altIndex.split(","); } else {
            ...
            function mergeLocators(tests)
            {
                ...
                return $.isArray(tests) || (tests = [ tests ]), void 0 === tests[0].alternation ? locator = tests[0].locator.slice() : $.each(tests, function (ndx, tst) {
                    if ("" !== tst.def) {
                        if (0 === locator.length) {
                            locator = tst.locator.slice(); } else {
                                ...
                                if (decisionTaker < altNdxs[mndx]) {
                                    ...
                                    if (decisionTaker !== possibilityPos.locator[alternation]) {
                                        ...
                                        for (resetMaskSet(!0), opts.keepStatic = !opts.keepStatic, isValidRslt = !0; validInputs.length > 0; ) {
                                            ...
                                            if (input !== opts.skipOptionalPartCharacter && !(isValidRslt = isValid(getLastValidPosition(void 0, !0) + 1, input, !1, fromSetValid))) {
                                                break;
                                            }
                                        }
                ...
                if (pos > -1 && !opts.keepStatic && void 0 === getMaskSet().validPositions[pos]) {
                    ...
                    if (tests.length > 2) {
                        for (var i = 0; i < tests.length; i++) {
                            ...
                            null === tests[i].match.fn && (prevTest = tests[i]), staticAlternations.length > 1)) {
        ...
        function caret(input, begin, end, notranslate)
        {
            ...
            input.setSelectionRange) {
                input.selectionStart = begin, input.selectionEnd = end; } else if (window.getSelection) {
        ...
        function pasteEvent(e)
        {
            ...
            if ($.isFunction(opts.onBeforePaste)) {
                if (pasteValue = opts.onBeforePaste(inputValue, opts), pasteValue === !1) {
        ...
        function inputFallBackEvent(e)
        {
            ...
            if (getBuffer().join("") !== inputValue) {
                ...
                getBuffer().length - inputValue.length !== 1 || inputValue.charAt(caretPos.begin) === getBuffer()[caretPos.begin] || inputValue.charAt(caretPos.begin + 1) === getBuffer()[caretPos.begin] || isMask(caretPos.begin)) {
                    ...
                    e.keyCode = Inputmask.keyCode.BACKSPACE, keydownEvent.call(input, e);
                }
                e.preventDefault();
            }
        }
                ...
                if (document.activeElement === input) {
                    ...
                    if (selectedCaret.begin === selectedCaret.end) {
                        if (doRadixFocus(selectedCaret.begin)) {
                            caret(input, opts.numericInput ? seekNext($.inArray(opts.radixPoint, getBuffer())) : $.inArray(opts.radixPoint, getBuffer())); } else {
                            var clickPosition = selectedCaret.begin, lvclickPosition = getLastValidPosition(clickPosition, !0), lastPosition = seekNext(lvclickPosition);
                            if (lastPosition > clickPosition) {
                                caret(input, isMask(clickPosition) || isMask(clickPosition - 1) ? clickPosition : seekNext(clickPosition)); } else {
    ...
    return Inputmask.extendAliases({
        numeric: {
            ...
            postFormat: function (buffer, pos, opts) {
                ...
                if (bufVal.length > 0 && opts.autoGroup || -1 !== bufVal.indexOf(opts.groupSeparator)) {
                    ...
                    if (bufVal = "" === opts.radixPoint ? bufVal : radixSplit[0], bufVal !== opts.prefix + "?0" && bufVal.length >= opts.groupSize + opts.prefix.length) {
                        for (var reg = new RegExp("([-+]?[\\d?]+)([\\d?]{" + opts.groupSize + "})"); reg.test(bufVal) && "" !== opts.groupSeparator; ) {
                ...
                if (e && ("blur" === e.type || "checkval" === e.type || "keydown" === e.type)) {
                    ...
                    "" !== processValue && isFinite(processValue)) {
                        ...
                        if (floatValue.toString() !== processValue && floatValue.toString() + "." !== processValue || isNegative) {
                            return !isNegative || 0 === floatValue && "blur" === e.type || (processValue.unshift(opts.negationSymbol.front),
                ...
                if (!strict) {
                    if (opts.numericInput === !0) {
                        ...
                        if (matchRslt && (-1 === radixPosition || radixPosition >= pos)) {
                            ...
                            if (0 === matchRslt[0].indexOf("" !== opts.placeholder ? opts.placeholder.charAt(0) : "0") && (matchRslt.index + 1 === pos || isSelection !== !0 && 0 === decimalPart)) {
                            ...
                            if ("0" === chrs && pos <= matchRslt.index && matchRslt[0] !== opts.groupSeparator) {
                                return !1;
                            }
                        }
                    }
            ...
            isComplete: function (buffer, opts) {
                ...
                if (opts.postFormat(bufClone, 0, opts), bufClone.join("") !== maskedValue) {
                    return !1;
                }
                var processValue = maskedValue.replace(opts.prefix, "");
                return processValue = processValue.replace(opts.suffix, ""), processValue = processValue.replace(new RegExp(Inputmask.escapeRegex(opts.groupSeparator), "g"), ""),
            ...
            onBeforeMask: function (initialValue, opts) {
                if ("" !== opts.radixPoint && isFinite(initialValue)) {
                    initialValue = initialValue.toString().replace(".", opts.radixPoint); } else {
                        ...
                        function validateRegexToken(token, fromGroup)
                        {
                            ...
                            for (var mndx = 0; mndx < token.matches.length; mndx++) {
                                ...
                                if (matchToken.isGroup === !0) {
                                    isvalid = validateRegexToken(matchToken, !0); } else if (matchToken.isQuantifier === !0) {
